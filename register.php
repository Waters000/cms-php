...
<?php
    if ($_SERVER['REQUEST_METHOD']=="POST") {
        ...
        if (!isset($error)) {
            ...
            try {
                $sql = "INSERT INTO users (firstname, lastname, username, email, password, comments, validationcode, active, joined, last_login) VALUES (:firstname, :lastname, :username, :email, :password, :comments, :vcode, 1, current_date, current_date)";
